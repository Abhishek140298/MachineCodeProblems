...
const AnalogClock = () => {
  ...
  const sencondDeg = (seconds / 60) * 360 - 90;
  const minuteDegree = (minutes / 60) * 360 + seconds * (1 / 10) - 90;
  const hourDeg = ((hours % 12) / 12) * 360 + (minuteDegree / 60) * 30 - 90;
  useEffect(() => {
  ...
  return (
    ...
    >
      ...
      >
        <div style={handStyle(hourDeg, "70px", "black")}></div>
        <div style={handStyle(minuteDegree, "70px", "black")}></div>
        <div style={handStyle(sencondDeg, "70px", "black")}></div>
      </div>
    </div>
  );
};
